...
export type DomainEventType =
  ...
  | 'SPAY_BOOKING_RESCHEDULED'
  | 'SPAY_BOOKING_CANCELLED'
  | 'SPAY_REFUND_REQUESTED'
  | 'SPAY_REFUND_APPROVED'
  | 'SPAY_REFUND_INITIATED'
  | 'SPAY_REFUND_COMPLETED'
  | 'SPAY_REFUND_REJECTED'
  | 'SPAY_CHECK_IN_COMPLETED'
  | 'SPAY_OPERATION_COMPLETED'
  | 'SPAY_POST_OPERATIVE_CARE'
